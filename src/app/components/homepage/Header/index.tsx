...
const Header = () => {
    return (
        <>
            <header className="bg-[#F2F0F1] pt-0 md:pt-0 overflow-hidden">
                <div className="max-w-frame mx-auto grid gird-cols-2 md:grid-cols-2 lg:grid-cols-2">
                    <section className="max-w-frame px-4">
                        <motion.h2 
                            initial={{ y: "80px", opacity: 0, rotate: 10 }}
